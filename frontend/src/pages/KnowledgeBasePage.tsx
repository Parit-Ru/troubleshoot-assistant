...
import {
  KBTabSwitcher,
  type KBTab,
} from "@/features/knowledge-base/KBTabSwitcher";
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400">
            Indexed manuals and troubleshooting records
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <StatCard label="Manuals" value="847" />
        <StatCard label="Knowledge Chunks" value="12,480" />
        <StatCard label="KB Records" value="3,241" />
      </div>
      ...
      <Input
        placeholder={
          activeTab === "manuals"
            ? "Search by brand, model, or device..."
            : "Search records..."
        }
        value={searchTerm}
